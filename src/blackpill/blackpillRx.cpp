...
//     shiftIndex = indice;
//     nextShiftIndex = indice-1;
//     if(maxIndex < 10){
//         maxIndex++;
//     }
//     lostCount = 0;
//     count = 0;
//     TrackLost[indice] = count;
//     while(1)
//     {
//         if(shiftIndex < 0){
...
//         }
//         if(nextShiftIndex < 0){
//             nextShiftIndex = maxIndex- 1; 
//         }
        
//         if(TrackLost[indice] - TrackLost[nextShiftIndex] > tracking){
//             lostCount += tracking - (TrackLost[indice] - TrackLost[shiftIndex]);
//         }
//         lostCount += TrackLost[shiftIndex] - TrackLost[nextShiftIndex] + 1;

//         shiftIndex--;
        
//         if(shiftIndex == indice){
//             break;
//         }
//     }
//     indice++;
